...
$current_target = $wpdb->get_var("SELECT setting_value FROM $settings_table WHERE setting_key = 'babu_target'") ?: '0/100';
$target = strpos($current_target, '/') !== false ? $current_target : '0/100';
